...
<div class="content-page" ng-app = "mainApp" ng-controller = "studentController">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li><a href="{{Url(Request::segment(1).'/vote')}}">Vote Manage</a></li>
            ...
            {!! Form::open(array('url' => 'admin/submit_vote', 'method' => 'post','name' => 'studentForm', 'class' => 'cmxform form-horizontal tasi-form','files' => true )) !!}
