<div class="col-md-3 col-sm-5">
    ...
    if (!empty($categories)) {
        ...
        if ($categories->menutitle == 'শিক্ষা') {
            ?>
                        ...
                        if ($advertizing7[0]->image != '') {
                            ...
                            <div class="ctgry_bx_pd_ad" style="height:100px; margin-bottom: 10px">
                                ...
                                <a href=" @php echo $advertizing7[0]->url;@endphp ">
                                    <img src="{{ URL::asset('uploads/ads/'.$advertizing7[0]->image)}}" class="img img-responsive"
                    ...
                    <div class="row">
                        <div class="gogl_ad_area">
                            ...
                            <a href=" @php echo $advertizing8[0]->url;@endphp "> <img
                                    src="{{ URL::asset('uploads/ads/'.$advertizing8[0]->image)}}" class="top_ad_3"/></a>
