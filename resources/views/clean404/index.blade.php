...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        <title>No pages here as you see!</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <meta http-equiv="Content-Style-Type" content="text/css" />
        <link href="{{ URL::asset('error/style.css')}}" rel="stylesheet" type="text/css" />
    </head>
    ...
    <body>
        <div id="main">
            ...
            <div id="content">
                <ul class="nav">
                    <li class="home"><a href="{{URL('/')}}">Home Page</a></li>
            ...
            <!-- footer -->
            <div id="footer">
                Designed by Winuxsoftltd - all <a href="http://www.winuxsoftltd.com" target="_blank">website</a> found and safe!
            </div>
        </div>
    </body>
</html>