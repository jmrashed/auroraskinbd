...
<html>
    <head>
        ...
        <!-- Page Title -->
        <title>Boishakhi Online News Portal</title>
        <!-- Styles -->
            ...
            <div class="wrapping_padd">
                ...
                <div class="row">
                    <div class="blck_bar">
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-12 bng_word_img"><div class="bar_position"><a href="{{ URL::asset('frontend_source/assets/fonts/solaimanlipi.ttf')}}">
                                    <img src="{{ URL::asset('frontend_source/assets/images/bangla_word.png')}}" border="0" /></a></div></div>
                ...
                <div class="row nav_position">
                    ...
                    <div class="col-md-1 col-sm-1">
                        <div class="row">
                            <a href="{{URL('/live')}}">
                                <img src="{{ URL::asset('frontend_source/assets/images/live_btn.gif')}}" style="width:100%; height:54px; border:none;"> 
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <nav class="navbar main-menu">
                            <div class="navbar-header">
                                <div class="mobil_live_btn">
                                    <a href="{{URL('/live')}}"><img style="width:82px; height:54px; border:none;" src="{{ URL::asset('frontend_source/assets/images/live_btn.gif')}}"> </a>
                                </div>
                            ...
                            if (sizeof($advertizing1) > 0) {
                                if ($advertizing1[0]->type == 'Image') {
                                    if ($advertizing1[0]->image != '') {
                                        ?>
                                        <!-- <h1>2</h1> -->
                                        <a href=" @php echo $advertizing1[0]->url;@endphp ">  
                                            <img src="{{ URL::asset('uploads/ads/'.$advertizing1[0]->image)}}" style="width: 1160px; height: 60px" /></a>
                            ...
                            if (sizeof($advertizing5) > 0) {
                                if ($advertizing5[0]->type == 'Image') {
                                    if ($advertizing5[0]->image != '') {
                                        ?>
                                        <!-- <h1>10</h1> -->
                                        <a href=" @php echo $advertizing5[0]->url;@endphp ">  
                                            <img src="{{ URL::asset('uploads/ads/'.$advertizing5[0]->image)}}" style="width: 1160px; height: 90px;" /></a>
                                        <?php
                                    }
                                } else {
                                    ?>
