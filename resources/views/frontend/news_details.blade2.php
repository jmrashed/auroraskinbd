                                    ...
                                    if ($details->youtube != '') {
                                        ...
                                        if (preg_match("/(youtube.com|youtu.be)\/(watch)?(\?v=)?(\S+)?/", $youtubeurl, $matchlink)) {
                                            ...
                                            if ($matchlink[1] == 'youtube.com') {
                                                ...
                                                ?>
                                                <iframe width="100%" height="500" src="{{$newLink}}" frameborder="0"
                                    ...
                                    if (sizeof($advertizing9) > 0) {
                                        if ($advertizing9[0]->type == 'Image') {
                                            ...
                                            <div class="col-md-12" style="text-align:center">
                                                <div class="row">
                                                    <a href=" @php echo $advertizing9[0]->url;@endphp "> <img
                                                            src="{{ URL::asset('uploads/ads/'.$advertizing9[0]->image)}}"
                                                            class="top_ad_2"/></a>
...
//echo $url_0;
                                ...
                                <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2F{{$weburl}}&layout=button&size=small&mobile_iframe=true&appId=120300978643881&width=59&height=20" width="59" height="20" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
                                ...
                                <div class="single-post-meta" style="background: none; margin-top: -100px;padding: 0px">
                                    ...
                                    <ul class="pull-left">
                                        ...
                                        @if(Auth::guard('admin')->user()) <li><a href="{{url('/')}}/admin/user_post_edit/{{$details - > newsid}}" style="color: red"  class="btn btn-lg" style="width: 160px"><i class="fa fa-edit"> </i> আপডেট  [ by {{Auth::guard('admin')->user()->name}} ]</a></li> @endif
                                        @if(Auth::guard('superadmin')->user())<li><a href="{{url('/')}}/superadmin/post-edit/{{$details - > newsid}}"  style="color: green" class="btn btn-lg" style="width: 160px"><i class="fa fa-edit"> </i> আপডেট  [ by Superadmin ]</a></li>  @endif
                                                    ...
                                                    <div class="post-header">
                                                        ...
                                                        <?php if ($lastNews->news_sub_title_2) { ?>
                                                            <h4 style="font-size: 18px; font-weight: normal; text-align: left;">
                                                                <a href="{{URL('/'.$lastNews - > newsid.'/'.$newsslugfilter)}}"><?php //echo $lastNews->news_sub_title_2;  ?></a>
                                                            </h4>
                                                        <?php } ?>
                    ...
                    if (sizeof($post_comments) > 0) {
                        ...
                        foreach ($post_comments as $comments) {
                            ...
                            <div class="single-comment">
                                <div class="media">
                                    <div class="media-left text-center">
                                        <img src="{{ URL::asset('backend_source/images/user.png') }}" alt="user-img"
                                             border="0" class="img-circle">
                                    </div>
                                    <div class="media-body">
                                        <div class="media-heading">
                                            <h3 class="text-uppercase">{{$comments - > name}} 
            ...
            <div class="col-md-3 col-sm-5">
                ...
                if (isset($details->newsid)) {
                    ...
                    foreach ($MebuId as $adsmenuId) {
                        $ads_display = DB::table('boi_ads')->where('categorie_id', $adsmenuId->menuid)->take(1)->get();
                        foreach ($ads_display as $row) {
                            ?>
                            <div class="ctgry_bx_pd_ad" style="height:100px; margin-bottom: 10px">
                                <a href=" @php echo $row->url;@endphp ">
                                    <img src="{{ URL::asset('uploads/ads/'.$row->image)}}" class="img img-responsive"
                                         style="height:100px; width: 265px;"/>
                                </a>
                            </div>
                            <?php
                        }
                            ...
                            <div class="col-md-12" id="dads">
                                <div class="row">
                                    <div class="gogl_ad_area">
                                        <a href=" @php echo $advertizing8[0]->url;@endphp "> <img
                                                src="{{ URL::asset('uploads/ads/'.$advertizing8[0]->image)}}"
                                                class="top_ad_3"/></a>
                                    ...
                                    if ($n <= 3) {
                                        ...
                                        <div class="popular-post">
                                            <a href="{{URL('/'.$lastNews - > newsid.'/'.$newsslugfilter)}}" class="popular-img">
                                                <img src="{{ URL::asset('uploads/news/'.$lastNews->news_image)}}"
