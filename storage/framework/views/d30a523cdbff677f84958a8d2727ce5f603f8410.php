 ...
 <div class="gallery">
    ...
    <div class="container">
      <div class="gallery-grids">
        <?php 
          $boi_gallerys=DB::table('boi_gallery')->select('*')->where('status',1)->orderby('created_at', 'DESC')->take(9)->get();
          
          foreach ($boi_gallerys as $row) {?>
          <div class="col-md-4 col-sm-4 gallery-grid">
            <div class="grid">
              <figure class="effect-apollo">
                <a class="example-image-link" href="<?php echo e(asset('/uploads/gallery')); ?>/<?php echo e($row->image); ?>" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ut sem ac lectus mattis sagittis. Donec pulvinar quam sit amet est vestibulum volutpat. Phasellus sed nibh odio. Phasellus posuere at purus sit amet porttitor. Cras euismod egestas enim eget molestie. Aenean ornare condimentum odio, in lacinia felis finibus non. Nam faucibus libero et lectus finibus, sed porttitor velit pellentesque.">
                  <img src="<?php echo e(asset('/uploads/gallery')); ?>/<?php echo e($row->image); ?>" alt="">
                  <figcaption>
