...
<div class="content-page">
    ...
    <div class="content">
        <div class="container" ng-app = "mainApp" ng-controller = "studentController">
            ...
            {!! Form::open(array('url' => 'superadmin/submit_user', 'method' => 'post','name' => 'studentForm', 'class' => 'cmxform form-horizontal tasi-form','files' => true )) !!}
            <div class="row">
                <div class="col-md-8">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <span style = "color:red" ng-show = "studentForm.type.$dirty && studentForm.type.$invalid">
                                                    <span ng-show = "studentForm.type.$error.required">User type is required.</span>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <input class="form-control" id="designation" name="designation" type="text" ng-model="designation" required placeholder="Enter designation">

                                                <span style = "color:red" ng-show = "studentForm.designation.$dirty && studentForm.designation.$invalid">
                                                    <span ng-show = "studentForm.designation.$error.required">Designation is required.</span>
                                                </span>
                                            </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="panel panel-default" id="replace">
                                                ...
                                                <div class="panel-heading">
                                                    <button class="btn btn-default waves-effect waves-light" disabled="disabled" onmouseover="checkStatus(1)" ng-disabled = "studentForm.name.$invalid || studentForm.designation.$invalid || studentForm.email.$invalid || studentForm.password.$invalid || studentForm.type.$invalid">Save Draft</button>
                                                    <button class="btn btn-primary waves-effect waves-light" disabled="disabled" onmouseover="checkStatus(2)" ng-disabled = "studentForm.name.$invalid || studentForm.designation.$invalid || studentForm.email.$invalid || studentForm.password.$invalid || studentForm.type.$invalid">Publish</button>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                foreach ($data as $activedata) {
                                    ...
                                    //dd($checksub);
                                    ?>
                                    <span style="padding-left:10px;"><input type="checkbox" class="control-label" value="{{$activedata - > menuid.'_0'}}" name="categories[]" checked="checked" /> {{$activedata - > menutitle}} </span> <br />
                                    <?php
                                    if ($checksub) {
                                        foreach ($checksub as $activedata) {
                                            ?>
                                            <span style="padding-left:30px;"><input type="checkbox" class="control-label" value="{{$menuid.'_'.$activedata - > menuid}}" name="categories[]" checked="checked"/> {{$activedata - > menutitle}} </span> <br />
                                            <?php
                                        }
                                    }
                                    ?>
