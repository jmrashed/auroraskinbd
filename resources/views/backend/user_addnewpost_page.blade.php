...
<div class="content-page">
    ...
    <div class="content">
        <div class="container" ng-app = "mainApp" ng-controller = "studentController">
            ...
            {!! Form::open(array('url' => 'admin/user_submit_post', 'method' => 'post','name' => 'studentForm', 'class' => 'cmxform form-horizontal tasi-form','files' => true )) !!}
            <div class="row">
                <div class="col-md-8">
                        ...
                        <div class="panel-body">  
                            <div style="" class="row custom_header">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control"  name="news_sub_title_1" type="text" title="Enter Subtitle 1 title optional"   placeholder="Enter Subtitle 1 title "> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea  class="form-control"  style="height: 90px"  id="ckeditor" name="title" type="text" ng-model="title" required placeholder="Enter Main title here"></textarea>                
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="news_sub_title_2" type="text"  title="Enter Subtitle 2 title optional"   placeholder="Enter Subtitle 2 title"> 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                <div class="col-lg-12">
                                    <textarea class="form-control" id="article-ckeditor" name="article_ckeditor" style="height:400px;" placeholder="Description"></textarea>
                                </div>
                            </div>
                            ...
                            <div style="" class="row custom_header">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <input class="form-control" id="youtube" name="youtube" type="text" placeholder="Youtube Url">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <input class="form-control" id="seotitle" name="seotitle" type="text" placeholder="SEO title here">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <textarea class="form-control" id="seodescription" name="seodescription" style="height:200px;" placeholder="SEO Description"></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3">SEO Key Tag</label>
                                    <div class="col-sm-9">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default" id="replace">
                        ...
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-primary waves-effect waves-light" disabled="disabled" onmouseover="checkStatus(3)" ng-disabled = "studentForm.title.$invalid"> Publish </button>

                            <input type="hidden" name="newsstatus" id="newsstatus" readonly="readonly"/>

                            <button class="btn btn-default waves-effect" type="button" onclick="goBack()"> Back </button>
                ...
                <div class="col-md-4">
                    <div class="panel panel-default" id="replace">
                        ...
                        <div class="panel-heading">
                            ...
                            <span style="padding-left:10px;"><input type="checkbox" class="control-label" value="1" name="today_program" /> আজকের বিশেষ আয়োজন</span> <br />
                            <span style="padding-left:10px;"><input type="checkbox" class="control-label" value="1" name="latest" /> সর্বশেষ</span> <br />
                            <span style="padding-left:10px;"><input type="checkbox" class="control-label" value="1" name="nirbachito"/> নির্বাচিত</span> <br />
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                foreach ($data as $activedata) {
                                    ...
                                    //dd($checksub);
                                    ?>
                                    <span style="padding-left:10px;"><input type="checkbox" class="control-label" value="{{$activedata - > menuid.'_0'}}" name="categories[]" /> {{$activedata - > menutitle}} </span> <br />
