            ...
            <div class="wrapping_padd">
                    ...
                    <div class="blck_bar">
                        <div class="col-md-2 col-sm-3 col-xs-12 bar_position">
                            <div class="top-social-icons">
                                <a href="https://www.facebook.com/Boishakhimedia/" target="_blank"><i
                                        class="fa fa-facebook"></i></a>
                                <a href="https://twitter.com/Boishakhimedia" target="_blank"><i class="fa fa-twitter"></i></a>
                                <a href="https://www.google.com/+BoishakhiTvmedia" target="_blank"><i
                                        class="fa fa-google-plus"></i></a>
                                <a href="http://www.youtube.com/boishakhitvbd" target="_blank"><i class="fa fa-youtube"></i></a>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-12 bng_word_img">
                            <div class="bar_position"><a href="{{ URL::asset('frontend_source/assets/fonts/solaimanlipi.ttf')}}">
                                    <i class="fa fa-download" aria-hidden="true" style="padding: 4px; border: 1px solid #007a48; color: #ee1c27; box-shadow: 1px 1px 2px #007a48;"></i>
                                    <img src="{{ URL::asset('frontend_source/assets/images/bangla_word.png')}}" border="0" style="padding: 2px; width: 130px;" /></a>
                            </div>
                        </div>
                        <div class="col-md-5 col-sm-3 col-xs-12 bar_position" style="margin-top:8px">
                            <style>
                                .lng{    
                                    color: white;
                                    width: 20px;
                                ...
                                .lng:hover{background:green; }
                            </style>
                            <a class="lng" href="http://www.boishakhionline.com/en/" style="color:white; font-weight:bold">English</a>
                ...
                <div class="row nav_position">
                    ...
                    <div class="col-md-1 col-sm-1">
                        <div class="row">
                            <a href="{{URL('/live')}}">
                                <img src="{{ URL::asset('frontend_source/assets/images/live_btn.gif')}}"
                        ...
                        <nav class="navbar main-menu">
                            <div class="navbar-header">
                                <div class="mobil_live_btn">
                                    <a href="{{URL('/live')}}"><img style="width:82px; height:54px; border:none;"
                                                                    src="{{ URL::asset('frontend_source/assets/images/live_btn.gif')}}">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-11 col-sm-10 col-xs-8 headline_sec">
                            <span>
                                <marquee align="top" behavior="scroll" direction="left"
                                         ...
                                         scrolldelay="30" truespeed="truespeed">
                                    @php
                                    ...
                                    <i class="fa fa-hand-o-right"></i> <a
                                        href="{{URL('/'.$hdnews->newsid.'/'.$newsslugfilter)}}"
                                        style="color:#FFF;">{{$hdnews->newstitle}}</a>
                                    @endforeach
                                </marquee>
                            </span>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="copyright-area">
                            <div class="copy-text pull-left">
                                <p>&copy; 2017 All Rights Reserved, <a href="{{URL('/')}}">বৈশাখী টেলিভিশনের খবর বিভাগের
                                        তত্ত্বাবধানে </a>, Developed by <a href="http://boishakhitv.com/" target="_blank">Boishakhi
                                        TV </a></p>
                            </div>
                            <div class="pull-right social-share footer-social-icon">
                                ...
                                <ul class="">
                                    ...
                                    <li><a href="https://www.facebook.com/Boishakhimedia/" target="_blank"><i
                                                class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/Boishakhimedia" target="_blank"><i
                                                class="fa fa-twitter"></i></a></li>
                                    <li><a href="https://www.google.com/+BoishakhiTvmedia" target="_blank"><i
                                                class="fa fa-google-plus"></i></a></li>
                                    <li><a href="http://www.youtube.com/boishakhitvbd" target="_blank"><i
