...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            {!! Form::open(array('url' => 'superadmin/update_media', 'method' => 'post','class' => 'cmxform form-horizontal tasi-form','files' => true )) !!}
            ...
            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <input class="form-control" id="title" name="title" type="text" ng-model="title" value="{{$edit - > title}}" required placeholder="Enter title here">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-12">
                                                <input class="form-control" id="youtube" name="youtube" type="text" ng-model="youtube" value="{{$edit - > youtube}}" required placeholder="Youtube Url">
                                            </div>
                                        </div>
                ...
                <div class="col-md-4">
                    <div class="panel panel-default" id="replace">
                        ...
                        <div class="panel-heading">
                            <button class="btn btn-default waves-effect waves-light" onmouseover="checkStatus(1)">Save Draft</button>
                            <button class="btn btn-primary waves-effect waves-light" onmouseover="checkStatus(2)">Publish</button>
