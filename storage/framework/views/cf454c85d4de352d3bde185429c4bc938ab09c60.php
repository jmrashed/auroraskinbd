...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title" style="    color: green; font-weight: bold;">Welcome  <?php if(Auth::user()->desi): ?> Editor [  <?php echo e($user = Auth::user()->name); ?> ] <?php else: ?> Superadmin [  <?php echo e($user = Auth::user()->name); ?> ] <?php endif; ?>  </h4>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="mini-stat clearfix bx-shadow" style="background:green">
                        <a href="<?php echo e(url('/')); ?>/admin/user_posts">
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                <div class="mini-stat clearfix bx-shadow" style="background:green">
                    <a href="<?php echo e(url('/')); ?>/admin/user_newadd">
        ...
        <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
            <div class="mini-stat clearfix bx-shadow" style="background:#3c763d">
                <a href="<?php echo e(url('/')); ?>/superadmin/posts">
    ...
    <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
        <div class="mini-stat clearfix bx-shadow" style="background:#3c763d">
            <a href="<?php echo e(url('/')); ?>/superadmin/newadd">
...
<div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
    <div class="mini-stat clearfix bx-shadow" style="background:#337ab7">
        <a href="<?php echo e(url('/')); ?>/superadmin/ads">
...
<div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
    <div class="mini-stat clearfix bx-shadow" style="background:#337ab7">
        <a href="<?php echo e(url('/')); ?>/superadmin/newaddads">
            <span class="mini-stat-icon bg-info"> <i class="fa fa-plus" aria-hidden="true"></i></span>
            <div class="mini-stat-info text-right text-muted" >
                <h4 style="color:white">Ads Manage</h4>
        </a>
...
<div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
    <div class="mini-stat clearfix bx-shadow" style="background:#33b86c">
        <a href="<?php echo e(url('/')); ?>/superadmin/user">
...
<div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
    <div class="mini-stat clearfix bx-shadow" style="background:#33b86c">
        <a href="<?php echo e(url('/')); ?>/superadmin/useradd">
...
<div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
    <div class="mini-stat clearfix bx-shadow" style="background:#0486f7">
        <a href="<?php echo e(url('/')); ?>/superadmin/media">
...
<div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
    <div class="mini-stat clearfix bx-shadow" style="background:#0486f7">
        <a href="<?php echo e(url('/')); ?>/superadmin/newaddmedia">
    ...
    if (Auth::user()->desi) {
        ...
        <table class="table table-reponsive table-bordered">
            ...
            foreach ($today_my_post as $row) {
                ...
                <tr><td><?= $ii++; ?></td>
                    <td style="width: 60%">  <a href="<?php echo e(URL('/'.$row->newsid.'/'.$newsslugfilter)); ?>"><?php echo $row->newstitle; ?></a> </td>
                    <td><?= $row->newscreatetime; ?></td> 
                    <td><a href="<?php echo e(url('/')); ?>/admin/user_post_edit/<?= $row->newsid; ?>">Edit </a></td>
                </tr>
