...
<div class="container">
    ...
    <span style="color: green;" class="alert alert-success"> {!!Session::get('success')!!} </span>
    @endif

    @if(Session::has('delete'))
    <span style="color: red;" class="alert alert-success"> {!!Session::get('delete')!!} </span>
    @endif
    <div class="row" ng-app = "mainApp" ng-controller = "studentController">
        {!! Form::open(array('url' => 'admin/submit_headline', 'method' => 'post','name' => 'studentForm','class' => 'cmxform form-horizontal tasi-form','novalidate','files' => true)) !!}
        <div class="col-sm-12">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>     
                                                    <div class="row">
                                                        {{-- < span class = "edit" > < a href = "{{URL('admin/headline-edit/'.$datavalue->id)}}">Edit</a> | </span> --}}
                                                        <span class="trash" style="margin-left: 10px;">
                                                            <a href="{{URL('admin/headline-delete/'.$datavalue - > id)}}" class="submitdelete">
                                                                Delete</a></span>
                                                    </div>
                                                </td>
                                            </tr>
