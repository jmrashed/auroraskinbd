                            ...
                            if (sizeof($advertizing1) > 0) {
                                if ($advertizing1[0]->type == 'Image') {
                                    if ($advertizing1[0]->image != '') {
                                        ?>
                                        <a href=" @php echo $advertizing1[0]->url;@endphp ">  <img src="{{ URL::asset('uploads/ads/'.$advertizing1[0]->image)}}" class="top_ad_1"/></a>
                            ...
                            if (sizeof($advertizing7) > 0) {
                                if ($advertizing7[0]->type == 'Image') {
                                    if ($advertizing7[0]->image != '') {
                                        ?>
                                        <a href=" @php echo $advertizing7[0]->url;@endphp ">  <img src="{{ URL::asset('uploads/ads/'.$advertizing7[0]->image)}}" class="top_ad_7"/></a>
                                        <?php
                                    }
                                } else {
                                    ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <aside class="footer-widget">
                            <h3 class="footer-title text-uppercase">আবহাওয়া</h3>

                            <iframe src="https://www.meteoblue.com/en/weather/widget/three/dhaka_bangladesh_1185241?geoloc=fixed&days=6&tempunit=CELSIUS&windunit=KILOMETER_PER_HOUR&layout=dark"  frameborder="0" scrolling="NO" allowtransparency="true" sandbox="allow-same-origin allow-scripts allow-popups" style="width: 100%;height:280px;"></iframe><div>
                    ...
                    <div class="col-md-12">
                        <div class="copyright-area">
                            <div class="copy-text pull-left">
                                <p>&copy; 2017 All Rights Reserved, <a href="{{URL('/')}}">বৈশাখী টেলিভিশনের খবর বিভাগের তত্ত্বাবধানে </a>, Designed by <a href="http://winuxsoftltd.com/" target="_blank">WinuxSoftLtd </a></p>
                            </div>
