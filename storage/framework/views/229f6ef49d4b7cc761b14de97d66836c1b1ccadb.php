            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="<?php echo e(url('dashboard')); ?>" class="logo"><i class="md"></i> <span>Boishakhi</span></a>
                    </div>
                </div>
                ...
                <div class="sidebar-inner slimscrollleft">
                        ...
                        <div class="user-info">
                            <div class="dropdown">
                                ...
                                <!--<li><a href="javascript:void(0)"><i class="md md-face-unlock"></i> Profile<div class="ripple-wrapper"></div></a></li>-->
                                    ...
                                    <?php else: ?>
                                    <li><a href="<?php echo e(url('/superadmin/logout')); ?>"><i class="md md-lock"></i> Logout</a></li>
                                    <form id="logout-form" action="<?php echo e(url('/superadmin/logout')); ?>" method="POST" style="display: none;">
                                        <?php echo e(csrf_field()); ?>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(url('superadmin/dashboard')); ?>" class="waves-effect active"><i class="fa fa-dashboard"></i><span> Dashboard </span></a>
                            </li>
