        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <a href="{{ url('superadmin/useradd') }}"><button class="btn btn-default waves-effect" type="button" style="margin-top:5px;">Add New</button></a>
                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$activedata->name}}
                                                        <div class="row-actions">
                                                            <span class="edit"><a href="{{URL('superadmin/user-edit/'.$activedata->id)}}">Edit</a> | </span>

                                                            <span class="trash">
                                                                <a href="{{URL('superadmin/user-delete/'.$activedata->id)}}" class="submitdelete">
                                                                    Delete</a></span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        Editor
                                                        @elseif($activedata->type==2)
                                                        Reporter
                                                        @elseif($activedata->type==3)
                                                        Superadmin
                                                        @endif
