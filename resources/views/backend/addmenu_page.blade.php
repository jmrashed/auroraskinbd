    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row" ng-app = "mainApp" ng-controller = "studentController">
                {!! Form::open(array('url' => 'menusubmit', 'method' => 'post','name' => 'studentForm','class' => 'cmxform form-horizontal tasi-form','novalidate','files' => true)) !!}
                <div class="col-sm-12">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control" ng-model="menutype" required name="menutype">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" id="firstname" name="firstname" type="text" ng-model="firstname" ng-minlength="4" required>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10 col-sm-9">
                                        <input type="checkbox" style="width: 16px" class="checkbox form-control" id="status" name="status" value="1" checked="checked">
                                    </div>
                                </div>
