...
<div class="content-page" ng-app = "mainApp" ng-controller = "studentController">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li><a href="<?php echo e(Url(Request::segment(1).'/galleryalbum')); ?>">Gallery Album Manage</a></li>
            ...
            <?php echo Form::open(array('url' => 'admin/submit_galleryalbum', 'method' => 'post','name' => 'studentForm', 'class' => 'cmxform form-horizontal tasi-form','files' => true )); ?>
